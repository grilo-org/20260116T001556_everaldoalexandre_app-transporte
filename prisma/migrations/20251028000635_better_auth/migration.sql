/*
  ...
  - The primary key for the `Demandas` table will be changed. If it partially fails, the table could be left without primary key constraint.
...
*/
-- AlterTable
ALTER TABLE "Demandas" DROP CONSTRAINT "Demandas_pkey",
ALTER COLUMN "id" DROP DEFAULT,
ALTER COLUMN "id" SET DATA TYPE TEXT,
ADD CONSTRAINT "Demandas_pkey" PRIMARY KEY ("id");
DROP SEQUENCE "Demandas_id_seq";
